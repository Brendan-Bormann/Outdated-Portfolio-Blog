    ...
    return (
      <div className="Home animated fadeIn">
        ...
        <div className="Home-Buttons">
            <Link className="waves-effect waves-light btn btn-flat white Home-Btn" to={"/portfolio"} >Portfolio</Link>
            <Link className="waves-effect waves-light btn btn-flat white Home-Btn" to={"/github"} >GitHub</Link>
            <Link className="waves-effect waves-light btn btn-flat white Home-Btn" to={"/blog-list"} >Blogs</Link>
            <Link className="waves-effect waves-light btn btn-flat white Home-Btn" to={"/contact"} >Contact</Link>
        </div>
      </div>
    );
  }
